...
context['get_video_camera_response']= response.json()


try:
	json_string = json.dumps(context['get_video_camera_response'])
	json_object = json.loads(json_string)
	if "failed" in context['get_video_camera_response']:
		MSA_API.task_error(context['get_video_camera_response'],context, True)
	MSA_API.task_success(context['get_video_camera_response'],context, True)
