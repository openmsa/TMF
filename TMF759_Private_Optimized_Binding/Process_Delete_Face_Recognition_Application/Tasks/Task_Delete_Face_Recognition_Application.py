...
#context['del_face_rec_app_response']= response.json()
context['del_face_rec_app_response']= str(response)

try:
	json_string = json.dumps(context['del_face_rec_app_response'])
	json_object = json.loads(json_string)
	if "failed" in context['del_face_rec_app_response']:
		MSA_API.task_error(context['del_face_rec_app_response'],context, True)
	context['ca_id']=""
	json_response = json.dumps(context['del_face_rec_app_response'], indent=4)
