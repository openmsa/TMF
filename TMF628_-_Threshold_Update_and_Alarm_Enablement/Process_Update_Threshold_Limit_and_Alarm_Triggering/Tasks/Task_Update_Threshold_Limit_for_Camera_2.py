...
dev_var = Variables()
dev_var.add('cam2_uplink_bitrate_threshold', var_type='String')
...
GET_PROCESS_NAME ='Process/workflows/TMF628_Performance_Management/Process_Update_Threshold_Limit'
EXTERNAL_REF=context['camera2_wf_instance']
...
{
  "uplink_bitrate_threshold": "1099899"
}

'''

data=dict(uplink_bitrate_threshold=context['cam2_uplink_bitrate_threshold'])
